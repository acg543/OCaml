...
type arithToken = PLUS | DIV | TIMES | NEG | CONST of float
...
type arithExpr = ConstExpr of float | DivExpr of arithExpr * arithExpr | NegExpr of arithExpr | AddExpr of arithExpr * arithExpr | MultExpr of arithExpr * arithExpr
...
let e2 : arithExpr = ConstExpr 2.0;;
